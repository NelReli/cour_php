...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['ajouter'])) {
    $nom = trim(htmlspecialchars($_POST['nom'])); // On récupère et nettoie le nom
    $pc = trim(htmlspecialchars($_POST['ordinateur_numero'])); // On récupère et nettoie le numéro de PC
